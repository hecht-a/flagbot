...
exports.getLeavingMessageChannelEmbed = void 0;
...
async function getLeavingMessageChannelEmbed(message) {
    const channelId = await getValueFromDB_1.getValueFromDB("servers", "leaving_message_channel", { server_id: message.guild?.id });
...
exports.getLeavingMessageChannelEmbed = getLeavingMessageChannelEmbed;
