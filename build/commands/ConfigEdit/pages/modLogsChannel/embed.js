...
exports.getModLogsChannelEmbed = void 0;
...
async function getModLogsChannelEmbed(message) {
    const channelId = await getValueFromDB_1.getValueFromDB("servers", "mod_logs_channel", { server_id: message.guild?.id });
...
exports.getModLogsChannelEmbed = getModLogsChannelEmbed;
